...
/**
 * Rambler/News feed platform (RSS 2.0 + `content:encoded`).
 *
 * Generates a standard RSS 2.0 feed compatible with the Rambler news
 ...
 *
 * @see https://help.rambler.ru/news/partners/1151/
 */
final class RamblerNews extends AbstractContentRssPlatform
{
    /**
     * {@inheritDoc}
     */
